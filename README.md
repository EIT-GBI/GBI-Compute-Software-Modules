...
| [`gbi`](gbi/README.md) | verified HPC data movement, portable archives and resumable parts; automatic Slurm and optional managed Prefect submission; native OCI selection in development | no — in-tree Python source; needs Python 3.9+ and rclone; Prefect option needs the site broker |
