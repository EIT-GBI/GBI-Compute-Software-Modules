local base        = "/Users/johannes.blaschke/Developer/cli-util-mods/opt/lmod/lmod/settarg"
...
local exitCmd = "eval `" .. "/Users/johannes.blaschke/Developer/cli-util-mods/opt/bin/lua " .. settarg_cmd .. " -s " .. myShell .. " --destroy`"
